...
<div class="relative z-50">
	<button
		...
		aria-haspopup="menu"
		aria-controls="theme-mode-panel"
		aria-expanded="false"
	...
	<div
		...
		data-floating-panel
		data-floating-panel-trigger="scheme-switch"
		inert
		aria-hidden="true"
	>
		<DropdownPanel>
			...
			>
				<Icon icon="material-symbols:brightness-auto-outline-rounded" class="text-[1.25rem] mr-3"
				></Icon>
