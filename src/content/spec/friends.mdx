...
export const site = {
  ...
  avatar: "https://www.tasaed.top/blog/assets/logos/T832.png",
...
export const notes = [
  { title: "互换原则", content: "请先将本站添加到您的友链页面，我会在确认后添加您的友链。" },
  { title: "链接维护", content: "如发现友链网站长期无法访问或内容违规，将会移除友链。" },
  { title: "内容要求", content: "内容积极向上，无违法违规/色情/反动/暴力信息。不允许含有病毒、木马、恶意代码、弹出广告以及任何危害他人计算机安全的内容。" },
  { title: "站点要求", content: "网站能够正常访问，加载速度合理。支持 HTTPS，以原创内容为主，能够正常访问且有持续更新" },
];
